    ...
    <body style="background-color:#65AFB2;">
				...
				<div class="collapse navbar-collapse text-center" id="collapsibleNavbar">
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item botoesDoMenu ml-2 mr-2">
							<a class="nav-link text-light " href="frequencia_disc/controleFrequencia.php">Controle de Frequência</a>
						</li>
					</ul>
				</div>
			</ul>	
        ...
        <div class="pl-2 pr-2 mb-4 ">
            <div class="container corpoDasOpções mt-5 pt-2" style="">
                ...
                <hr class="hrBranco"/>
                <form action="">
                        <input type="submit" class="btn btn-light botõesOpções btn-block mb-3" value="Controle da Frequência" formaction="frequencia_disc/controleFrequencia.php"/>
                </form>
            </div>
        </div>
	</body>
