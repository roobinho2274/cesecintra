    ...
    <body>
        ...
        <div class = "container" style="background-color: buttonface" >
            ...
            <form name="delta" action="delDisc.php">
                ...
                <input type="submit" class="btn btn-primary btn-block " value="Controle Servidor" formaction="professor/controleProfessor.php"/><br><br>
                ...
                <input type="submit" class="btn btn-primary btn-block" value="Controle Frequência" formaction="frequencia/controleFrequencia.php"/><br><br>
            </form>
