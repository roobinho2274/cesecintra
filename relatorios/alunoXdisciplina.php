...
<html>
	...
	<body style="background-color:#65AFB2;">
		...
		<hr class="hrBranco">
		<h2 class="text-light strong text-center">Relatório de Disciplinas</h2>
		<hr class="hrBranco">
		<div class="MensagemRelatorio mb-3">
			Selecione a disciplina para ver os alunos que estão matriculadas nesta disciplina.
		</div>	
    		<div class="form-group row ">
                <label class="col-lg-2 col-sm-12 col-form-label strong text-center">Disciplinas</label>
			...
			<div class="pl-4 pr-4 mb-2 mt-3 mb-2 ">
