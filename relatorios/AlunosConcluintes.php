...
<div class="pl-2 pr-2">
    <div class="mt-5 mb-3 container corpoRelatorio">
        <hr class="hrBranco">
        <h2 class="text-light strong text-center">Relatório de Alunos Concluintes</h2>
        <hr class="hrBranco">
        <div class="MensagemRelatorio mb-3">
            Selecione o aluno para ver matriculas que ele concluiu.
        </div>
        <div class="form-group row mx-auto">
            <label class="col-lg-2 col-sm-12 col-form-label strong text-center">Alunos:</label>
            <div class="col-lg-10 col-sm-12">
                <select class="form-control" name="aluno7" id="combobox_aluno">
                    ...
                    while($r = mysqli_fetch_assoc($res) ) {
                        $sql2 = "SELECT * FROM matricula WHERE dataConclusao <> '' AND idAluno = '".$r['id']."'";
